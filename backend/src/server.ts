...
//   // --- DEFINITIVE FIX: Event to handle read receipts more reliably ---
//   socket.on('mark_as_read', async (data) => {
//     try {
//       const { conversationId, currentUserId, otherUserId } = data;

//       // Update the messages in the database and return the IDs of the messages that were changed
...
//       // If any messages were actually updated, notify the original sender with the specific IDs
//       if (updatedMessageIds.length > 0) {
//         io.to(otherUserId.toString()).emit('messages_read', { 
//           conversationId,
//           updatedMessageIds // Send the specific IDs back
//         });
//       }
//     } catch(error) {
